...
public partial class Network : Node
{
	...
	private void HandleAppVersionError(string jsonError, AuthenticationRequestFailed authenticationRequestFailed = null)
	{
		Dictionary<string, object> response = JsonReader.Deserialize<Dictionary<string, object>>(jsonError);
	...
	private string ExtractStatusMessage(string jsonError)
	{
		Dictionary<string, object> response = JsonReader.Deserialize<Dictionary<string, object>>(jsonError);
