...
public partial class DialogManager : Control
{
	...
	public void ShowPostScoreDialog(double time, Network.PostScoreRequestCompleted postScoreRequestCompleted = null, Network.PostScoreRequestFailed postScoreRequestFailed = null)
	{
		if (!m_PostScoreDialog.IsShowing())
		{
			m_PostScoreDialog.Set(time, postScoreRequestCompleted, postScoreRequestFailed);
	...
	public void ShowAttachEmailDialog(Network.AttachEmailIdentityCompleted attachEmailIdentityCompleted = null, Network.AttachEmailIdentityFailed attachEmailIdentityFailed = null)
	{
		...
		{
			m_AttachEmailDialog.Set(attachEmailIdentityCompleted, attachEmailIdentityFailed);
