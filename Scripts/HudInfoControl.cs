...
public partial class HudInfoControl : Control
{
	...
	public void Init(Achievement achievement, Vector2 position, HudInfoControlHoldCompleted hudInfoControlHoldCompleted = null)
	{
		Init("Achievement: " + achievement.Title, position, 1.5, hudInfoControlHoldCompleted);
	}
