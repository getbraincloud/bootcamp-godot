...
public partial class EmailLoginDialog : Dialog
{
	...
	public void OnAnonymousButtonClicked()
	{
		Hide();
		DialogManager.sharedInstance.ShowConnectingDialog();
		GetNetwork.AuthenticateAnonymous(m_AuthenticationRequestCompleted, m_AuthenticationRequestFailed);
	}
	...
	public void OnTwitchButtonClicked()
	{
		Hide();
		DialogManager.sharedInstance.ShowConnectingDialog();
		GetNetwork.RequestTwitchAuthentication(m_AuthenticationRequestCompleted, m_AuthenticationRequestFailed); 
	}
